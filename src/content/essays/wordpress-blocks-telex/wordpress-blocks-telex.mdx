...
import telexWordpressBlockTutorialEnhancePrompt from "./telex-wordpress-block-tutorial-enhance-prompt.jpeg";
import telexCreatingBlocksWordpress from "./telex-creating-blocks-wordpress.jpeg";
import wordpressBlockExample from "./wordpress-block-example.gif";
import telexWordpressBlockEditorView from "./telex-wordpress-block-editor-view.jpeg";
...
[In my earlier essay about vibe coding](/what-is-vibe-coding-how-to-do-it/), I described it as programming by conversation: you talk to an AI, the AI throws code back, and together you shape something that works.
...
<Figure src={telexWordpressBlockTutorialEnhancePrompt} alt={"Telex prompt for creating a WordPress block with vibe coding."}>
  Telex prompt for creating a WordPress block for the Gutenberg editor
</Figure>
...
<Figure src={telexCreatingBlocksWordpress} alt={"Telex creating WordPress blocks automatically."}>
  Telex acknowledging the prompt and creating my custom WordPress block
</Figure>

And here is the working Gutenberg block:

<Figure src={wordpressBlockExample} alt={"The Christmas quotes Telex block in action, rotating famous Christmas quotes at the press of a green button."} />
...
<Figure src={telexWordpressBlockEditorView} alt={"Telex WordPress block editor."}>
  Telex didn’t create color options like you’d normally see in core WordPress blocks
</Figure>
