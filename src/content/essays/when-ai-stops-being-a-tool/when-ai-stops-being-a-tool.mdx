...
seoDescription: AI removed so much friction that I built for eighteen hours a day. I had to notice when a useful tool had started setting my pace and priorities.
date: 2026-06-23
updated: 2026-06-30
sticky: false
cornerstone: false
...
newsletterIntro: |-
  We let AI set the rhythm. Instead of leading it, we let ourselves be led by it, following it blindly.
categories:
  - Observations
tags:
  - ADHD
...
audio: when-ai-stops-being-a-tool.mp3
---

import Figure from "../../../components/content/Figure.astro";
import QuickSummary from "../../../components/content/QuickSummary.astro";
import claudeChatPrompt from "./claude-chat-prompt.jpg";
import whatItCosts from "./what-it-costs.jpg";
...
But it doesn’t tell you about [the burnout cycle](/adhd-planner/) waiting on the other side: the high that crashes into silence, the silence that breaks into another high, the pattern you can’t willpower your way out of.
...
I stopped using AI as a tool. I started letting it [set the rhythm](/vibe-writing-line-between-human-machine/).
...
<Figure src={claudeChatPrompt} alt={"Claude Chat prompt box, ready to accept a prompt."} />
...
<Figure src={whatItCosts} alt={"Person working late at a laptop in a dim office, surrounded by charts and a coffee mug."} />
