...
In 2016, an article I wrote about [[woocommerce-password-strength-meter-checkout|removing the password strength meter in WooCommerce]] got a backlink from WordPress.org by [Mike Jolley](https://mikejolley.com/), the creator of WooCommerce, and overnight, my traffic exploded. I felt unstoppable. Every new comment, every view, and every spike in Analytics gave me a hit of energy. I started challenging myself to write daily, and I actually did. For three straight weeks, there was new content every morning.
...
Naturally, I wanted to apply what I’d learned to my blog too. One night, I decided to clean up spammy backlinks using the [Disavow tool](https://support.google.com/webmasters/answer/2648487?hl=en). It felt responsible, professional, even. The next morning, my views dropped from hundreds a day to zero.
...
That was precisely how I had been blogging for years. Some weeks, I was hyperfocused, writing endlessly, editing at 2 a.m., and publishing daily. Other times, I couldn’t even open the WordPress dashboard. What I had been calling burnout wasn’t ordinary exhaustion. It was what many clinicians refer to as [ADHD burnout](https://add.org/adhd-burnout/): the crash that follows long periods of running purely on excitement and novelty.

After the diagnosis, I spent months learning how it actually affected my life. I learned how [Combined ADHD is the most common presentation](https://www.cdc.gov/adhd/about/?CDC_AAref_Val=https://www.cdc.gov/ncbddd/adhd/facts.html), showing patterns of both inattentive and hyperactive-impulsive symptoms in daily life.
