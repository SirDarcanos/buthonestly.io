...
newsletterIntro: |-
  These five WordPress plugins give you clean comments, SEO, analytics, security, and safe customization without bloating your site.
categories:
  - Web
tags:
  - Productivity
...
audio: top-5-essential-wordpress-plugins-i-always-install-and-why.mp3
---

import Figure from "../../../components/content/Figure.astro";
import QuickSummary from "../../../components/content/QuickSummary.astro";
import scamCall from "./scam-call.jpg";
import officeGoogleSearch from "./office-google-search.jpg";
import siteKitGoogle from "./site-kit-google.jpg";
import ferrariPerformance from "./ferrari-performance.jpg";
import codeSnippets from "./code-snippets.jpg";
...
<Figure src={scamCall} alt={"Angry man shouting into a telephone handset while seated at a desk against a white background."}>
  Photo by [Icons8 Team](https://unsplash.com/@icons8?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText) on [Unsplash](https://unsplash.com/photos/married-couple-standing-beside-beige-wall-IsRIjvgpj5Y?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText)
</Figure>
...
<Figure src={officeGoogleSearch} alt={"Person using a laptop displaying Google Search at a wooden table beside a cup of coffee."}>
  Photo by [Firmbee.com](https://unsplash.com/@firmbee?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText) on [Unsplash](https://unsplash.com/?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText)
</Figure>
...
<Figure src={siteKitGoogle} alt={"Google Analytics dashboard showing real-time users, traffic charts, revenue, and top countries."}>
  Photo by [1981 Digital](https://unsplash.com/@1981digital?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText) on [Unsplash](https://unsplash.com/?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText)
</Figure>
...
<Figure src={ferrariPerformance} alt={"Ferrari dashboard showing the tachometer, speedometer, warning lights, and an open-door alert."}>
  Photo by [mostafa jamei](https://unsplash.com/@mostafa_jamei?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText) on [Unsplash](https://unsplash.com/?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText)
</Figure>
...
<Figure src={codeSnippets} alt={"Close-up of colorful programming code on a screen, with sharp text in the center and blurred edges."}>
...
If you’re setting up a new WordPress site (or cleaning up an existing one), I recommend giving these a try. Start small, activate only what you need, and build from there, [making smart WordPress choices](/do-you-trust-your-instincts-making-smart-wordpress-choices/).
