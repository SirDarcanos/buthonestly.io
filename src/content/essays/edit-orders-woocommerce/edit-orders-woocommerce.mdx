...
newsletterIntro: |-
  Editing WooCommerce orders means adjusting details without breaking payments, using notes, refunds, and statuses to keep everything aligned.
categories:
  - Web
tags:
  - WordPress
...
import orderDetailsScreen from "./order-details-screen.jpg";
import orderActions from "./order-actions.jpg";
import orderNotes from "./order-notes.jpg";
import orderItems from "./order-items.jpg";
import editOrderItems from "./edit-order-items.jpg";
import editOrderItemsButtons from "./edit-order-items-buttons.jpg";
import addItemsButtons from "./add-items-buttons.jpg";
...
<Figure src={orderDetailsScreen} alt={"The WooCommerce order details panel, showing the customer's general, billing, and shipping information."} />
...
<Figure src={orderNotes} alt={"The WooCommerce Order notes panel, listing status-change and customer notes."} />
...
<Figure src={orderItems} alt={"The WooCommerce order items list, showing purchased products with quantities, costs, and totals."} />
...
<Figure src={editOrderItems} alt={"The WooCommerce refund form, with per-item amount, tax, and total fields to fill in."} />
...
<Figure src={editOrderItemsButtons} alt={"The WooCommerce order items section for an unpaid (On Hold) order, with editable items plus Add and Recalculate buttons."} />
...
<Figure src={addItemsButtons} alt={"The WooCommerce “Add item(s)” buttons for adding a product, fee, shipping, or tax to an order."} />
