...
seoDescription: Compare 10 types of websites, where WordPress fits, and when a specialist no-code platform is the better tool for the site you want to build.
date: 2025-12-07
updated: 2026-08-19
sticky: false
cornerstone: false
...
audio: 10-types-of-websites.mp3
---

import Figure from "../../../components/content/Figure.astro";
import QuickSummary from "../../../components/content/QuickSummary.astro";
import wordpressComVsOrg from "./wordpress-com-vs-org.jpg";
import stripe from "./stripe.jpg";
import listable from "./listable.jpg";
import wikigg from "./wikigg.jpg";
import substack from "./substack.jpg";
import senseilms from "./senseilms.jpg";
import woocommerce from "./woocommerce.jpg";
...
<Figure src={wordpressComVsOrg} alt={"The WordPress logo in a diamond shape with cicled .com and .org words."}>
  Image by Automattic
</Figure>
...
My own blog is the exception rather than the counterexample. I [moved it to Astro](/wordpress-to-astro/) because it is one person writing essays and I wanted the constraints to be mine. For the site most people mean when they say they need one, the answer above is still WordPress.
...
<Figure src={stripe} alt={"The Stripe logo on a blue background"}>
  Image by Stripe
</Figure>

When it comes to taking money online, I think in two sizes: **tiny** and **serious**. Once a shop gets serious, the product data is where the work goes — starting with [attributes versus variations](/woocommerce-attributes-vs-variations/).
...
<Figure src={listable} alt={"The Listable logo on a salmon background."}>
  Image by Listable
</Figure>
...
<Figure src={wikigg} alt={"The wiki.gg logo on a white background."}>
  Image by wiki.gg
</Figure>
...
<Figure src={substack} alt={"The Substack logo on a white background."}>
  Image by Substack
</Figure>
...
<Figure src={senseilms} alt={"The SenseiLMS logo on a white background."}>
  Image by Automattic
</Figure>
...
<Figure src={woocommerce} alt={"The WooCommerce logo on an abstract purple background."}>
  Image by Automattic
</Figure>
