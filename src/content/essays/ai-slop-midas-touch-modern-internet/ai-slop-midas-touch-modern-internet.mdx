...
seoTitle: "AI Slop: The Midas Touch of the Modern Internet"
date: 2025-11-24
updated: 2026-05-12
sticky: false
cornerstone: false
...
newsletterIntro: |-
  I shared six years of Steam review data on Reddit. The thread skipped the methodology and argued about the AI-made infographic instead.
categories:
  - Observations
tags:
  - AI
...
audio: ai-slop-midas-touch-modern-internet.mp3
---
...
I love it not in the “I play it sometimes” way. In the “I think about this game enough to write [the equivalent of a dissertation about it](/distilroberta-emotion-analysis-nlp-case-study/)” way.
...
I follow a specific format when [I give effective feedback](/mastering-effective-feedback-facts-feelings-curiosity/): start with **facts**, own your **feelings**, and add **curiosity** instead of assumptions.
...
Let’s get specific. For the [Dead by Daylight emotion analysis](/distilroberta-emotion-analysis-nlp-case-study/), here’s what **I** did:
...
I’ve written before about [vibe writing in 2025](/vibe-writing-line-between-human-machine/): our tolerance for AI changes dramatically depending on _where_ it shows up.
...
I’ve written about [how gaming made me a better leader](/gaming-made-me-better-leader/): pattern recognition, risk management, knowing when to commit and when to disengage, and treating each match as information.
