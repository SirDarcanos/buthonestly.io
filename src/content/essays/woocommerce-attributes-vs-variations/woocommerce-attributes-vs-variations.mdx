...
newsletterIntro: |-
  Attributes describe product details. Variations turn those details into concrete choices that control price, stock, and what customers buy.
categories:
  - Web
tags:
  - WordPress
...
audio: woocommerce-attributes-vs-variations.mp3
---

import Figure from "../../../components/content/Figure.astro";
import QuickSummary from "../../../components/content/QuickSummary.astro";
import woocommerceAttributes from "./woocommerce-attributes.jpeg";
import woocommerceVariations from "./woocommerce-variations.jpeg";
...
<Figure src={woocommerceAttributes} alt={"The Attributes screen on a WooCommerce product showcasing three different product attributes: brand, color, and size, and their respective options"}>
  The Attributes screen of a t-shirt
</Figure>
...
<Figure src={woocommerceVariations} alt={"The variations screen on a WooCommerce product showing a clothing item with colors and sizes variations"}>
  The Variations screen of a t-shirt
</Figure>
...
[I wrote about this in more detail here](/make-product-attributes-linkable-woocommerce/). Attributes also decide what WooCommerce considers similar, which is why they matter for [related products](/improve-woocommerce-related-products-recommendations/), and why setting them across a catalogue is a job for [bulk editing](/bulk-edit-woocommerce-products-without-plugins/).
