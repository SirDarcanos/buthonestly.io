...
In this essay, I will share how I approach feedback, both giving and receiving it, using a mix of facts, feelings, and curiosity. It is not a perfect formula, but it has helped me create more honest conversations and stronger teams that feel [[psychological-safety-in-teams-people-first-leadership|psychologically safe]].

## Why Feedback Matters for Everyone

Feedback is how we grow. It is how we learn what is working, what is not, and how our actions affect others. Without it, we operate in the dark, relying on assumptions rather than clarity. I talked about this in my article about [[gaming-made-me-better-leader|how gaming made me a better leader]].
...
This way of framing feedback is similar to the [Situation–Behavior–Impact (SBI) model](https://fellow.ai/blog/sbi-feedback-model/), where you describe the situation, what the person did, and the impact it had. I find that adding the feeling part makes it even more personal and real. It shows vulnerability, and that often helps others open up too.
