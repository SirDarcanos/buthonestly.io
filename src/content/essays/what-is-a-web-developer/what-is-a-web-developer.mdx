...
seoDescription: I became a web developer before AI could write code for me. The slower route still has lessons for learning the web and building sound judgment.
date: 2026-01-13
updated: 2026-05-19
sticky: true
cornerstone: false
...
audio: what-is-a-web-developer.mp3
---

import Figure from "../../../components/content/Figure.astro";
import QuickSummary from "../../../components/content/QuickSummary.astro";
import ogameBrowserGame from "./ogame-browser-game.jpg";
import webDevelopmentIn2000s from "./web-development-in-2000s.jpg";
import confusedCat from "./confused-cat.jpg";
import hijabWomanFocusing from "./hijab-woman-focusing.jpg";
...
<Figure src={ogameBrowserGame} alt={"OGame browser interface showing a planet overview, resources, research, shipyard, and a list of planets."}>
  The home screen of OGame. Screenshot by Gameforge 4D GmbH © 2002.
</Figure>
...
<Figure src={webDevelopmentIn2000s} alt={"Early 2000s web development and browser on an old computer screen"} />
...
<Figure src={confusedCat} alt={"Curious tabby cat looking upward between two question marks on a bright orange and blue background."} />
...
Today, you can sit down with ChatGPT or another model, describe an app in plain language, and get back a working prototype. You can [vibe code your way through features](/what-is-vibe-coding-how-to-do-it/) without touching a tutorial. [Even in WordPress](/wordpress-blocks-telex/).
...
<Figure src={hijabWomanFocusing} alt={"Woman in a hijab concentrating at a desk between a laptop and tablet, with her hands pressed to her temples."} />
...
I’d lie if I said yes. I moved on to [coaching and leadership](/section/leadership/ "Leadership"), I still code, but [mostly in Python for machine learning](/neural-network-predict-resin-usage-3d-printed-miniatures/), rarely in PHP or for the web.
