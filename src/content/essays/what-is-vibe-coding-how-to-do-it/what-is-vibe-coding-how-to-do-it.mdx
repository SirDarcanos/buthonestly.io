...
audio: what-is-vibe-coding-how-to-do-it.mp3
---
...
import creationHumanAi from "./creation-human-ai.jpg";
...
<Blockquote author="Andrej Karpathy (@karpathy)" source="https://twitter.com/karpathy/status/1886192184808149383">
...
<Figure src={creationHumanAi} alt={"Human and robotic hands reaching toward each other against a plain white textured background."} />
...
You might be already doing it without realizing. The same shift has been happening in writing, where I ended up calling it [vibe writing](/vibe-writing-line-between-human-machine/), and inside the block editor with [Telex](/wordpress-blocks-telex/). Whatever you ship this way is still yours to license, which is [a decision worth making deliberately](/how-to-choose-a-software-license-for-your-next-project/).
