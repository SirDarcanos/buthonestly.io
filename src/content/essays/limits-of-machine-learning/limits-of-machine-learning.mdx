...
import sirDanielFortesque from "./sir-daniel-fortesque.jpg";
import machineLearningMedievilWrAnalysis from "./machine-learning-medievil-wr-analysis.jpg";
import machineLearningMedievilWrNormalProgression from "./machine-learning-medievil-wr-normal-progression.jpg";
import noobkillerroofMedievilWorldrecord from "./noobkillerroof-medievil-worldrecord.jpg";
...
<Figure src={sirDanielFortesque} alt={"Sir Daniel Fortesque poses with a sword and shield in a graveyard surrounded by zombies and an evil living tree."}>
  Image by Sony Music Entertainement
</Figure>
...
And because I can’t help myself, I wanted to see what happens if we point machine learning at this mess ([as I did before](/neural-network-predict-resin-usage-3d-printed-miniatures/)) and ask a simple, slightly arrogant question:
...
I’ll walk through this using the real MediEvil dataset. As we go, I’ll spell out the exact questions I’m answering and the data I’m pulling, so [this isn’t just vibes](/vibe-writing-line-between-human-machine/); it’s code, charts, and uncomfortable gaps between what the model says should happen and what speedrunners actually do.
...
<Figure src={machineLearningMedievilWrAnalysis} alt={"A line graph tracking the MediEvil speedrun world record progression from 2020 to 2025, highlighting key skips and runners."} />
...
<Figure src={machineLearningMedievilWrNormalProgression} alt={"A histogram showing the size and frequency of typical MediEvil Any% world record improvements, with most under 30 seconds."} />
...
If you just stare at the histogram, nothing looks exotic. Most updates sit in the 10–30 second range. A few are tiny (under 10 seconds). A handful are chunky 30–70 second leaps. It’s exactly what you’d expect from the narrative in Pap’s documentary:
...
I tried two polite little approaches you’d see in a [basic notebook](/neural-network-predict-resin-usage-3d-printed-miniatures/):
...
<Figure src={noobkillerroofMedievilWorldrecord} alt={"Screenshot of speedrunner NoobKillerRoof finishing a MediEvil Any% emulator run in 19:29, showing detailed splits on the left, a controller overlay, and the in-game dragon boss exploding as Twitch chat reacts to the new world record."}>
  NoobKillerRoof setting the current MediEvil Any% world record
</Figure>
...
It means we’re careful about what questions we let them answer, actually [collaborating with these tools](/what-is-vibe-coding-how-to-do-it/) instead of treating them like oracles.
