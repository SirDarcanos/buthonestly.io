...
newsletterIntro: |-
  Effective feedback blends facts, feelings, and curiosity to create honest, growth-focused conversations and a healthier team culture.
categories:
  - Leadership
tags:
  - Feedback
...
audio: mastering-effective-feedback-facts-feelings-curiosity.mp3
---

import Figure from "../../../components/content/Figure.astro";
import QuickSummary from "../../../components/content/QuickSummary.astro";
import effectiveFeedbackModel from "./effective-feedback-model.jpg";
import sharingCriticalFeedback from "./sharing-critical-feedback.jpg";
...
In this essay, I will share how I approach feedback, both giving and receiving it, using a mix of facts, feelings, and curiosity. It is not a perfect formula, but it has helped me create more honest conversations and stronger teams that feel [psychologically safe](/psychological-safety-in-teams-people-first-leadership/).

## Why Feedback Matters for Everyone

Feedback is how we grow. It is how we learn what is working, what is not, and how our actions affect others. Without it, we operate in the dark, relying on assumptions rather than clarity. I talked about this in my article about [how gaming made me a better leader](/gaming-made-me-better-leader/).
...
<Figure src={effectiveFeedbackModel} alt={"A black-and-white photo of a banner reading “WE HEAR YOU.” in bold letters."}>
...
<Figure src={sharingCriticalFeedback} alt={"Woman in white button up shirt sitting on gray couch, talking to another woman in a black blouse"}>
  Photo by [cottonbro studio](https://www.pexels.com/@cottonbro/) on [Pexels.com](https://www.pexels.com/)
</Figure>
